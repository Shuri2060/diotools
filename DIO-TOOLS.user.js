...
function DIO_GAME(version, gm, DATA, time_a) {
    ...
    var LANG = {
        ...
        es: {
            ...
            options: {
                ...
                // cha: ["Chat", 'Sustituye el chat de la alianza con un irc chat.'],
        ...
        br: {
            ...
            options: {
                ...
                // cha: ["Chat", 'Substituiu o da bate-papo por um bate-papo IRC.'],
        ...
        cz: {
            ...
            options: {
                ...
                spl: ["Okénko kouzel", "Stlačené klouzání oken & magnetické okénko kouzel (pozice paměti)"],
                ...
                // cha: ["Chat", 'Nahrazen alianční chat chatem IRC.'],
        ...
        $("#dio_tools").click(function () {
            ...
            if (!$('#dio_settings').get(0)) {
                ...
                $('<style id="dio_settings_style">' +
                    ...
                    '#donate_btn { background: url(' + dio_sprite + '); width:100px; height:26px; background-position: 0px -300px; } ' +
                ...
                $('.settings-container').append(
                    ...
                    ((Game.market_id === "de" || Game.market_id === "zz") ? (
                        ...
                        '<td><img src="https://diotools.de/images/game/settings/misc/chat_new.png" alt="" /></td>' +
    ...
    function setStyle() {
        ...
        $('<style id="dio_settings_style" type="text/css">' +
            '#dio_bg_medusa { background:url(http://diotools.de/images/game/settings/medusa_transp.png) no-repeat; height: 510px; width: 380px; right: -10px; top:6px; z-index: -1; position: absolute;} ' +
        ...
        if (typeof(ITowns) !== "undefined") {
            ...
            $.Observer(uw.GameEvents.game.load).subscribe('DIO_START', function (e, data) {
                ...
                if ((ch.length == 1) && exc && (sum == 28)) {
                    ...
                    if (DATA.options.cha && (Game.market_id === "de" || Game.market_id === "zz")) {
                        setTimeout(function () {
                            Chat.activate();
                        }, 0);
                    }
    ...
    var TownPopup = {
        activate : function(){
            ...
            $('<style id="dio_town_popup_style" type="text/css">' +
                ...
                '#dio_town_popup .god_content { width:24px; } ' +

                '#dio_town_popup .god_mini { height: 25px; width: 32px; background-size: 75%; background-position: 0px -122px; margin-right: -8px; } ' +

                    // God Icon
                '#dio_town_popup .god_mini.zeus { background-position: 0px 0px; } ' +
                '#dio_town_popup .god_mini.athena { background-position: 0px -24px; } ' +
                '#dio_town_popup .god_mini.poseidon { background-position: 0px -49px; } ' +
                '#dio_town_popup .god_mini.hera { background-position: 0px -73px; } ' +
                '#dio_town_popup .god_mini.hades { background-position: 0px -98px; } ' +
                '#dio_town_popup .god_mini.artemis { background-position: 0px -146px; } ' +
        ...
        add : function(that){
            ...
            if (typeof(uw.ITowns.getTown(townID)) !== "undefined") {
                ...
                // Title (town name)
                popup += "<h4><span style='white-space: nowrap;margin-right:35px;'>" + uw.ITowns.getTown(townID).name + "</span><img class='dio_branding' src='http://666kb.com/i/cifvfsu3e2sdiipn0.gif'></h4>";
        ...
        activate: function () {
            ...
            if($(".topleft_navigation_area").get(0)) {
                ...
                $('<style id="dio_available_units_style_addition">' +
                    ...
                    '.nui_main_menu { top: 293px !important; }' +
    ...
    var ShortDuration = {
        activate: function () {
            ...
            $('<style id="dio_short_duration_style">' +
                ...
                '.attack_support_window .dio_duration { border-spacing:0px; margin-bottom:2px; text-align:right; } ' +
                ...
                '.attack_support_window .short_icon { padding:20px 0px 0px 30px; background:url(http://666kb.com/i/ck2c7eohpyfa3yczt.png) 11px -1px / 21px no-repeat; filter: hue-rotate(50deg); -webkit-filter: hue-rotate(50deg); } ' +
                ...
                '.attack_support_window .fast_boats_needed { background:transparent url(http://s7.directupload.net/images/140724/4pvfuch8.png) no-repeat 0 0; padding:2px 10px 7px 24px; margin:13px 0px -8px 13px; } ' +
                '.attack_support_window .slow_boats_needed { background:transparent url(http://s1.directupload.net/images/140724/b5xl8nmj.png) no-repeat 0 0; padding:2px 10px 7px 24px; margin:13px 0px -8px 13px; } ' +
    ...
    var Simulator = {
        activate: function () {
            $('<style id="dio_simulator_style" type="text/css">' +
                ...
                '.place_simulator_table .place_image.research_divine_selection { background-position: 0 -600px; }' +
    ...
    var SimulatorStrength = {
        ...
        activate : function(){
            $('<style id="dio_simulator_strength_style">'+
                ...
                '#dio_simulator_strength .left_border { width: 54px; } '+
                '</style>'
            ).appendTo('head');
    ...
    var SmileyBox = {
        ...
        activate: function () {
            ...
            smileyArray.nature = [
                ...
                "insel", "fliegeschnappen", "spider", /* Spinne */ "shipwrecked", /* Schiffbrüchiger */ "plapperhase", "ben_dumbo"
            ];
            smileyArray.grepolis = [
                "mttao_wassermann", "hera", /* Hera */ "medusa", /* Medusa */ "manticore", /* Mantikor */ "cyclops", /* Zyklop */
                "minotaur", /* Minotaurus */ "pegasus", /* Pegasus */ "hydra", /* Hydra */
                "silvester_cuinlove", "mttao_schuetze", "kleeblatt2", "wallbash", /* "glaskugel4", */ "musketiere_fechtend", /* "krone-hoch",*/ "viking", // Wikinger
                "mttao_waage2", "steckenpferd", /* "kinggrin_anbeten2", */ "grepolove", /* Grepo Love */ "skullhaufen", "pferdehaufen" // "i/ckajscggscw4s2u60"
            ];
            smileyArray.people = [
                "seb_hut5", "opa_boese2", "star-wars-yoda1-gruen", "hexefliegend", "snob", "seb_detektiv_ani", "seb_cowboy", "devil", "segen", "pirat5", "borg", "hexe3b",
                "pharaoh", "hippie", "eazy_polizei", "stars_elvis", "mttao_chefkoch", "nikolaus", "pirate3_biggrin", "batman_skeptisch", "tubbie1", "tubbie2", "tubbie3", "tubbie4"
            ];
            smileyArray.other = [
                        ...
                        if (smileyArray[e].hasOwnProperty(f)) {
                            ...
                            if (src.substring(0, 2) == "i/") {
                                ...
                                if (SmileyBox.loading_error == false) {
                                    smileyArray[e][f].src = "https://diotools.de/images/smileys/"+ e +"/smiley_emoticons_" + src + ".gif";
    ...
    var Chat = {
        ...
        activate : function(){
            ...
            $('<style id="dio_chat_style">'+
                '#dio_chat { position: absolute; bottom: 0px; z-index: 4; width: 25%; transition: left 1.3s; left:0; -moz-user-select: text; -webkit-user-select: text; user-select: text; }'+
                '#dio_chat.resize { transition: left 0s; }'+

                '#dio_chat .slider { width:100%; height: 6px; top:0; right:1px;  position:absolute; margin-left:-8px; cursor: row-resize; }'+
                ...
                '#dio_chat .messagebox .time { float:left; color: #686; }'+
                '#dio_chat .messagebox .user { float:left; }'+
                '#dio_chat .messagebox .text { word-break: break-word; color: #797; }'+

                '#dio_chat .messagebox .welcome .text { color: rgb(200,220,200); }'+

                '#dio_chat .togglebutton { background: rgba(0,0,0,0.5); width: 24px; height: 100%; position: absolute; top: 0; right: -40px; color: #fc6; opacity:0.75; cursor: pointer; }'+
                '#dio_chat .togglebutton .top { height:4px; width:24px; background: url(https://diotools.de/images/game/button_sprite_vertical.png) 0px -1px; position:absolute;}'+
                '#dio_chat .togglebutton:hover .top { background-position: -25px -1px; }'+
                '#dio_chat .togglebutton .bottom { height:4px; width:24px; background: url(https://diotools.de/images/game/button_sprite_vertical.png) 0px 4px; position:absolute; bottom:0px; }'+
                '#dio_chat .togglebutton:hover .bottom { background-position: -25px 4px; }'+
                '#dio_chat .togglebutton .middle { height:100%; width:24px; background: url(https://diotools.de/images/game/button_sprite_vertical.png) -50px 0px; }'+
                '#dio_chat .togglebutton:hover .middle { background-position: -75px 0px; }'+
                '#dio_chat .togglebutton .arrow { position:absolute; left:6px; top:42.5%; }'+

                '#dio_chat .icon { position:absolute; right:10px; top:10px; opacity:0.15; width: 31px; height:31px; filter: sepia(0.5); background: url(http://666kb.com/i/d9xuhtcctx5fdi8i6.png) -50px -76px no-repeat; }'+

                '#dio_chat input { background: rgba(0, 0, 0, 0.5); color: white; border: 0px none; padding: 8px; width: 100%; border-right: 1px solid darkgreen; }'+
                '#dio_chat input:hover { background: rgba(0, 0, 10, 0.4); }'+
                '#dio_chat input:focus { background: rgba(0, 0, 10, 0.4); }'+
                '#dio_chat input::placeholder, '+
                '#dio_chat input::-webkit-input-placeholder, '+
                '#dio_chat input::-moz-placeholder, ' +
                '#dio_chat input:-ms-input-placeholder, '+
                '#dio_chat input:-moz-placeholder { color: black; }'+

                    // Chat im Menü ausblenden
            ...
            $('<div id="dio_chat"><div class="icon"></div><div class="messagebox"><div class="slider"></div></div><input type="text" placeholder="Nachricht eingeben..." /></div>').appendTo("#ui_box");

            $('<div class="welcome"><div class="time">'+ Chat.formatTime(Timestamp.server()) +':&nbsp;</div><div class="text">Hallo '+ Game.player_name + '! Willkommen im DIO-Tools Weltenchat ('+ Game.world_id +')</div></div>').appendTo("#ui_box .messagebox");

            $('<div class="togglebutton"><div class="top"></div><div class="middle"><div class="arrow">◄</div></div><div class="bottom"></div></div>').appendTo("#dio_chat");

            // Texteingabe
            $('#dio_chat input').keypress(function(e) {
            ...
            */
            ...
            // Ein-/Ausblenden der Chatbox
            $('#dio_chat .togglebutton').toggleClick(
                function () {
                    ...
                    setTimeout(function(){
                        $('#dio_chat .togglebutton .arrow').get(0).innerHTML = "►";
                    },1300);

                    // Tooltip
                    $('#dio_chat .togglebutton').tooltip("Chat öffnen");
                ...
                function (){
                    ...
                    // Tooltip
                    $('#dio_chat .togglebutton').tooltip("Chat schließen");
                }
            );
            // Wenn sich die Fenstergröße ändert

            $(window).on("resize.dio", function(){

                if($('#dio_chat').css("left") !== "0px"){

                    var x = -($(window).width() * 0.25 + 16);

                    $('#dio_chat').addClass("resize");
                    $('#dio_chat').css("left", x);

                    setTimeout(function(){
                        $('#dio_chat').removeClass("resize");
                    },0);
                }
            });
            ...
            // Skalierung der Höhe
            $('#dio_chat .slider').mousedown(function (e) {
                e.preventDefault();

                $('#dio_chat .messagebox').css("max-height", "none");

                $(document).on("mousemove.dio", function (e) {
                    e.preventDefault();

                    var x = $(window).height() - e.pageY - 49;

                    if (x > 30 && x < $(window).height() - 400) {
                        $('#dio_chat .messagebox').css("height", x );
                    }
                });
            });

            $(document).on("mouseup.dio", function (e) {
                $(document).off("mousemove.dio");

                //$('#dio_chat .messagebox')[0].scrollTop = $('#dio_chat .messagebox')[0].scrollTopMax;
                $('#dio_chat .messagebox')[0].scrollTop = $('#dio_chat .messagebox')[0].scrollHeight
            });
            ...
            // Öfter anfragen, wenn man chatten will
            $('#dio_chat').hover(function(){
                ...
                if(Chat.isOpened === true) {
                    ...
                    Chat.delay = 10000; // 10s

                    // Nach 5min nur noch alle 30s
                    Chat.timeout_A = setTimeout(function () {
                        Chat.delay = 30000;
                    }, 300000);

                    // Nach 15min nur noch alle 60s
            ...
            // Nur wenn Grepolis offen ist aktualisieren
            $(window).on("focus.dio", function() {
        ...
        deactivate : function(){
            ...
            $('#dio_chat_style').remove();
            $('#dio_chat').remove();

            // Events disconnecten
            $(document).off('mouseup.dio');
            $(window).off('focus.dio');
            $(window).off('blur.dio');
            $(window).off('resize.dio');
        },
        sendMessage : function(_message){
            ...
            $.ajax({
                type: "GET",
                url: "https://diotools.de/php/sendMessage.php?world=" + Game.world_id + "&time=" + Timestamp.server() + "&player="+ Game.player_name +"&message="+ _message,
                dataType: 'text',
                success: function (response) {
        ...
        getMessages : function(){
            ...
            if(Chat.isActivated === true) {
                ...
                var _url = "https://diotools.de/php/getMessages.php?world=" + Game.world_id;
                ...
                // Eventuell noch nicht gefeuertes Timeout entfernen
                    ...
                    $.ajax({
                        ...
                        success: function (_messages) {
                            if(Chat.isActivated === true) {
                                ...
                                // Letzte Abfragezeit speichern
                                Chat.timestamp = _currentTimestamp;

                                // console.debug("GET MESSAGES", _messages);

                                /*
                                var _scrollDown = false;
                                if ($('#dio_chat .messagebox')[0].scrollTop === $('#dio_chat .messagebox')[0].scrollTopMax) {
                                    _scrollDown = true;
                                }
                                */
        ...
        getUserColor : function(_user){
            ...
            if(typeof(Chat.user_colors[_user]) === "undefined") {
                ...
                // Bei zu dunkler Farbe neue Farbe ermitteln
        ...
        NewYear : {
            add : function(){
                ...
                $('<a href="http://www.greensmilies.com/smilie-album/" target="_blank"><div id="dio_newYear">'+
                    ...
                    '<img src="http://www.greensmilies.com/smile/sign2_7.gif">'+
